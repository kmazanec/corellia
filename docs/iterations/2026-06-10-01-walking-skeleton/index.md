---
type: iteration
title: "Iteration 01 — Walking skeleton: the single recursive operation"
description: The factory's own process builds its walking skeleton end to end — intent → contract barrier → parallel features → integration → grouped six-dimension review → repair → full suite.
tags: [iteration, walking-skeleton, contract, engine, eventlog, library, brains, scripted-brain, llm-brain]
timestamp: 2026-06-10
status: shipped
---

# Iteration 01 — Walking skeleton: the single recursive operation
...
six-dimension review → repair rung → full suite once. This is the durable
